...
func RenderHelp(s *data.AppState, b, p, bg compat.AdaptiveColor) string {
	...
	if useTwoColumns {
		...
		leftCol := lipgloss.JoinVertical(lipgloss.Left,
			...
			spacer.Width(colWidth).Render(key.Render("1-9")+sp("  ")+desc.Render("Jump to tab")),
		...
		helpContent = lipgloss.JoinVertical(lipgloss.Left,
			...
			spacer.Width(contentWidth).Render(key.Render("1-9")+" "+desc.Render("Jump to tab")),
			...
			spacer.Width(contentWidth).Render(key.Render("H/C")+" "+desc.Render("Hist/Charts")),
			spacer.Width(contentWidth).Render(key.Render("e")+" "+desc.Render("Export")),
			spacer.Width(contentWidth).Render(""),
		...
		helpContent = lipgloss.JoinVertical(lipgloss.Left,
			...
			spacer.Width(contentWidth).Render(key.Render("1-9")+sp("               ")+desc.Render("Jump to specific tab")),
			...
			spacer.Width(contentWidth).Render(key.Render("z / x")+sp("   ")+desc.Render("Suspend / Resume")),
